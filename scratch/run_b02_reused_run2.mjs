 ...
 * Preserves all previous B02 experiment runs (5 BASELINE + 1 REUSED).
 */
...
async function executeB02ReusedRun2() {
  ...
  // 2. Record initial run count before REUSED Run 2
  ...
  console.log('\n====================================================');
  console.log('B02 REUSED RUN 2 EXECUTION REPORT');
  console.log('====================================================');
...
executeB02ReusedRun2().catch((err) => {
