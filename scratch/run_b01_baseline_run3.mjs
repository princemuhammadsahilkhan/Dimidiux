/**
 * Step 11 — B01 Baseline Run 3 Only
 * Executes exactly ONE additional controlled run for Task B01 under the BASELINE group.
 * Preserves all previous experiment runs (2 BASELINE + 2 REUSED).
 */
...
async function executeBaselineRun3() {
  ...
  // 2. Record initial run count before Baseline Run 3
  ...
  console.log('\n====================================================');
  console.log('B01 BASELINE RUN 3 EXECUTION REPORT');
  console.log('====================================================');
  ...
  console.log('Total Completed B01 BASELINE Runs:', baselineRunsAfter.length);
  console.log('Total Experiment Runs:', runsAfter.length);
  console.log('====================================================\n');
}

executeBaselineRun3().catch((err) => {
