...
async function executeB02BaselineRun5() {
  ...
  // 2. Record initial run count before Run 5
  ...
  console.log('\n====================================================');
  console.log('B02 BASELINE RUN 5 EXECUTION REPORT');
  console.log('====================================================');
...
executeB02BaselineRun5().catch((err) => {
