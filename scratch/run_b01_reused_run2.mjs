 ...
 * Preserves all previous experiment runs (2 BASELINE + 1 REUSED).
 */
...
async function executeReusedRun2() {
  ...
  console.log('\n====================================================');
  console.log('B01 REUSED RUN 2 EXECUTION REPORT');
  console.log('====================================================');
