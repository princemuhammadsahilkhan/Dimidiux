 ...
 * Preserves all previous B02 experiment runs (5 BASELINE + 3 REUSED).
 */
...
async function executeB02ReusedRun4() {
  ...
  // 2. Record initial run count before REUSED Run 4
  ...
  console.log('\n====================================================');
  console.log('B02 REUSED RUN 4 EXECUTION REPORT');
  console.log('====================================================');
...
executeB02ReusedRun4().catch((err) => {
