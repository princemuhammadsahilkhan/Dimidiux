/**
 * Step 11 — B01 Baseline Run 5 Only
 * Executes exactly ONE additional controlled run for Task B01 under the BASELINE group.
 * Preserves all previous experiment runs (4 BASELINE + 2 REUSED).
 */
...
async function executeBaselineRun5() {
  ...
  // 2. Record initial run count before Baseline Run 5
  ...
  console.log('\n====================================================');
  console.log('B01 BASELINE RUN 5 EXECUTION REPORT');
  console.log('====================================================');
