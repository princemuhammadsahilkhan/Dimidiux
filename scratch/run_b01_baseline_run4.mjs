/**
 * Step 11 — B01 Baseline Run 4 Only
 * Executes exactly ONE additional controlled run for Task B01 under the BASELINE group.
 * Preserves all previous experiment runs (3 BASELINE + 2 REUSED).
 */
...
async function executeBaselineRun4() {
  ...
  // 2. Record initial run count before Baseline Run 4
  ...
  console.log('\n====================================================');
  console.log('B01 BASELINE RUN 4 EXECUTION REPORT');
  console.log('====================================================');
