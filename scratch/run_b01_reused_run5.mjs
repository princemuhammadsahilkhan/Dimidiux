 ...
 * Preserves all previous experiment runs (5 BASELINE + 4 REUSED).
 */
...
async function executeReusedRun5() {
  ...
  console.log('\n====================================================');
  console.log('B01 REUSED RUN 5 EXECUTION REPORT');
  console.log('====================================================');
