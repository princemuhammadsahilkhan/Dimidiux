 ...
 * Preserves all previous B02 experiment runs (5 BASELINE + 4 REUSED).
 */
...
async function executeB02ReusedRun5() {
  ...
  // 2. Record initial run count before REUSED Run 5
  ...
  console.log('\n====================================================');
  console.log('B02 REUSED RUN 5 EXECUTION REPORT');
  console.log('====================================================');
...
executeB02ReusedRun5().catch((err) => {
