 ...
 * Preserves all previous experiment runs (5 BASELINE + 3 REUSED).
 */
...
async function executeReusedRun4() {
  ...
  console.log('\n====================================================');
  console.log('B01 REUSED RUN 4 EXECUTION REPORT');
  console.log('====================================================');
