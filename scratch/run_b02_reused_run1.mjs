/**
 * Step 11 — B02 REUSED Run 1 Only
 * Executes exactly ONE controlled run for Task B02 under the REUSED group using pinned capability cap_1788863616697_5im5s v1.
 * Preserves all 5 BASELINE runs intact.
 */
...
async function executeB02ReusedRun1() {
  ...
  // 2. Record initial run count before REUSED Run 1
  ...
  console.log('\n====================================================');
  console.log('B02 REUSED RUN 1 EXECUTION REPORT');
  console.log('====================================================');
...
executeB02ReusedRun1().catch((err) => {
